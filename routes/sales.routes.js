...
const { CreateSalesController, GetSalesController, EditSalesController, DeleteSalesController } = require('../controllers/sales.controller');

const salesRoutes = express.Router();

salesRoutes.post('/create-sales', authentication, authorize(["dealer", "distributor"]), CreateSalesController);
salesRoutes.get('/get-sales', authentication, authorize(["dealer", "distributor"]), GetSalesController);
